...
class Library(models.Model):
    id = models.AutoField(primary_key=True,unique=True)
    name = models.CharField(max_length=50,unique=True, blank=True,verbose_name='图书馆名称')
    curator = models.CharField(max_length=10,unique=True, blank=True,verbose_name='馆长')
    tel = models.CharField(max_length=20,unique=True, blank=True,verbose_name='联系电话')
    address = models.CharField(max_length=100,unique=True, blank=True,verbose_name='联系地址')
    ...
    introduce = models.TextField(blank=True,unique=True,verbose_name='图书馆简介')
...
class Sex(models.Model):
    id = models.AutoField(primary_key=True, unique=True)
    sex = models.CharField(default='男',max_length=4,blank=True,unique=True,verbose_name='性别')
...
class ReaderType(models.Model):
    id = models.AutoField(primary_key=True, unique=True)
    name = models.CharField(max_length=50,unique=True, blank=True,verbose_name='读者类型')
...
class Reader(models.Model):
    ...
    barcode = models.CharField(max_length=30,unique=True, blank=True, verbose_name='条形码')
...
class Borrow(models.Model):
    ...
    borrowtime = models.DateField(blank=True, verbose_name='借出日期')  # Field name made lowercase.
    backtime = models.DateField(blank=True, verbose_name='归还时间')  # Field name made lowercase.
    # operator = models.CharField(max_length=30, blank=True, null=True,verbose_name='操作者')
